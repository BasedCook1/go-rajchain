...
// Package ethclient provides a client for the rajchain RPC API.
package ethclient
...
import (
	...
	"github.com/rajchain/go-rajchain"
...
// Client defines typed wrappers for the rajchain RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, rajchain.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*rajchain.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (rajchain.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q rajchain.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q rajchain.FilterQuery, ch chan<- types.Log) (rajchain.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q rajchain.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg rajchain.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg rajchain.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg rajchain.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*rajchain.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg rajchain.CallMsg) (uint64, error) {
...
func toCallArg(msg rajchain.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *rajchain.SyncProgress {
	if p == nil {
		return nil
	}
	return &rajchain.SyncProgress{
