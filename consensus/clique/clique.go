...
// ecrecover extracts the rajchain account address from a signed header.
func ecrecover(header *types.Header, sigcache *sigLRU) (common.Address, error) {
	...
	// Recover the public key and the rajchain address
...
// rajchain testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // rajchain address of the signing key
...
// Author implements consensus.Engine, returning the rajchain address recovered
