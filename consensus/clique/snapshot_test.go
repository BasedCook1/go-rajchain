...
// mapped from textual names used in the tests below to actual rajchain private
...
// address retrieves the rajchain address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the rajchain address
	...
	tests := []cliqueTest{
		{
			...
			// batch (https://github.com/rajchain/go-rajchain/issues/17593). Whilst this
