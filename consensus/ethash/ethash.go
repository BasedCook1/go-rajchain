...
// all blocks' seal as valid, though they still have to conform to the rajchain
// consensus rules.
...
// still have to conform to the rajchain consensus rules.
...
// they still have to conform to the rajchain consensus rules.
