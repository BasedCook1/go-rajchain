...
import "github.com/rajchain/go-rajchain/common"

// MainnetBootnodes are the enode URLs of the P2P bootstrap nodes running on
// the main rajchain network.
var MainnetBootnodes = []string{
	// rajchain Foundation Go Bootnodes
...
// genesis hash and protocol. See https://github.com/rajchain/discv4-dns-lists for more
// information.
