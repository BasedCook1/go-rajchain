...
import (
	...
	"github.com/rajchain/go-rajchain/internal/jsre/deps"
	"github.com/rajchain/go-rajchain/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute rajchain requests through
