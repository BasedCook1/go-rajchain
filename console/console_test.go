...
import (
	...
	"github.com/rajchain/go-rajchain/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*ethconfig.Config)) *tester {
	...
	// Create a networkless protocol stack and start an rajchain service within
	...
	if err != nil {
		t.Fatalf("failed to register rajchain protocol: %v", err)
	}
