...
// Package p2p implements the rajchain p2p network protocols.
package p2p
...
import (
	...
	"github.com/rajchain/go-rajchain/p2p/discover"
	"github.com/rajchain/go-rajchain/p2p/enode"
	"github.com/rajchain/go-rajchain/p2p/enr"
...
type NodeInfo struct {
	...
	ENR   string `json:"enr"`   // rajchain Node Record
