...
coverpkg="github.com/rajchain/go-rajchain/..."
...
repo=$GOPATH/src/github.com/rajchain/go-rajchain
compile_fuzzer github.com/rajchain/go-rajchain/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer github.com/rajchain/go-rajchain/common/bitutil \
...
compile_fuzzer github.com/rajchain/go-rajchain/core/vm/runtime \
  FuzzVmRuntime fuzzVmRuntime\
  $repo/core/vm/runtime/runtime_fuzz_test.go

compile_fuzzer github.com/rajchain/go-rajchain/core/vm \
  FuzzPrecompiledContracts fuzzPrecompiledContracts\
  $repo/core/vm/contracts_fuzz_test.go,$repo/core/vm/contracts_test.go

compile_fuzzer github.com/rajchain/go-rajchain/core/types \
  FuzzRLP fuzzRlp \
  $repo/core/types/rlp_fuzzer_test.go

compile_fuzzer github.com/rajchain/go-rajchain/crypto/blake2b \
  Fuzz fuzzBlake2b \
  $repo/crypto/blake2b/blake2b_f_fuzz_test.go

compile_fuzzer github.com/rajchain/go-rajchain/accounts/keystore \
  FuzzPassword fuzzKeystore \
  $repo/accounts/keystore/keystore_fuzzing_test.go

pkg=$repo/trie/
compile_fuzzer github.com/rajchain/go-rajchain/trie \
  FuzzTrie fuzzTrie \
...
compile_fuzzer github.com/rajchain/go-rajchain/eth/protocols/snap \
...
compile_fuzzer github.com/rajchain/go-rajchain/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/rajchain/go-rajchain/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/rajchain/go-rajchain/tests/fuzzers/bls12381 \
...
compile_fuzzer github.com/rajchain/go-rajchain/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
  $repo/tests/fuzzers/secp256k1/secp_test.go

compile_fuzzer github.com/rajchain/go-rajchain/eth/protocols/eth \
