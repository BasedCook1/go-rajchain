...
const (
	...
	// rajchain
	MessageType_MessageType_rajchainGetPublicKey     MessageType = 450
	MessageType_MessageType_rajchainPublicKey        MessageType = 451
	MessageType_MessageType_rajchainGetAddress       MessageType = 56
	MessageType_MessageType_rajchainAddress          MessageType = 57
	MessageType_MessageType_rajchainSignTx           MessageType = 58
	MessageType_MessageType_rajchainTxRequest        MessageType = 59
	MessageType_MessageType_rajchainTxAck            MessageType = 60
	MessageType_MessageType_rajchainSignMessage      MessageType = 64
	MessageType_MessageType_rajchainVerifyMessage    MessageType = 65
	MessageType_MessageType_rajchainMessageSignature MessageType = 66
	// NEM
...
var (
	MessageType_name = map[int32]string{
		...
		450: "MessageType_rajchainGetPublicKey",
		451: "MessageType_rajchainPublicKey",
		56:  "MessageType_rajchainGetAddress",
		57:  "MessageType_rajchainAddress",
		58:  "MessageType_rajchainSignTx",
		59:  "MessageType_rajchainTxRequest",
		60:  "MessageType_rajchainTxAck",
		64:  "MessageType_rajchainSignMessage",
		65:  "MessageType_rajchainVerifyMessage",
		66:  "MessageType_rajchainMessageSignature",
	...
	MessageType_value = map[string]int32{
		...
		"MessageType_rajchainGetPublicKey":                      450,
		"MessageType_rajchainPublicKey":                         451,
		"MessageType_rajchainGetAddress":                        56,
		"MessageType_rajchainAddress":                           57,
		"MessageType_rajchainSignTx":                            58,
		"MessageType_rajchainTxRequest":                         59,
		"MessageType_rajchainTxAck":                             60,
		"MessageType_rajchainSignMessage":                       64,
		"MessageType_rajchainVerifyMessage":                     65,
		"MessageType_rajchainMessageSignature":                  66,
