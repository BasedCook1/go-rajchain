...
// the `coin_type` 60' (or 0x8000003C) to rajchain.
//
// The root path for rajchain is m/44'/60'/0'/0 according to the specification
// from https://github.com/rajchain/EIPs/issues/84, albeit it's not set in stone
