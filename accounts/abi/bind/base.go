...
// valid rajchain transaction.
type TransactOpts struct {
	From   common.Address // rajchain account to send the transaction from
...
// rajchain network. It contains a collection of methods that are used by the
// higher level contract bindings to operate.
type BoundContract struct {
	address    common.Address     // Deployment address of the contract on the rajchain blockchain
	abi        abi.ABI            // Reflect based ABI to access the correct rajchain methods
...
// DeployContract deploys a contract onto the rajchain blockchain and binds the
...
func (c *BoundContract) Call(opts *CallOpts, results *[]interface{}, method string, params ...interface{}) error {
	...
	var (
		msg    = rajchain.CallMsg{From: opts.From, To: &c.address, Data: input}
