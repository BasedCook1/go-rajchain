...
// Package bind generates rajchain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-rajchain Wiki page:
// https://github.com/rajchain/go-rajchain/wiki/Native-DApps:-Go-bindings-to-rajchain-contracts
package bind
