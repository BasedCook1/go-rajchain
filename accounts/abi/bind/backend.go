...
type ContractCaller interface {
	...
	// CallContract executes an rajchain contract call with the specified data as the
	// input.
	CallContract(ctx context.Context, call rajchain.CallMsg, blockNumber *big.Int) ([]byte, error)
}
...
type PendingContractCaller interface {
	...
	// PendingCallContract executes an rajchain contract call against the pending state.
	PendingCallContract(ctx context.Context, call rajchain.CallMsg) ([]byte, error)
}
...
type BlockHashContractCaller interface {
	...
	// CallContractAtHash executes an rajchain contract call against the state at the specified block hash.
	CallContractAtHash(ctx context.Context, call rajchain.CallMsg, blockHash common.Hash) ([]byte, error)
}
