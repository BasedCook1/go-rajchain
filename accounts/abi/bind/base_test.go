...
func (mt *mockTransactor) EstimateGas(ctx context.Context, call rajchain.CallMsg) (gas uint64, err error) {
	return 0, nil
}
...
func (mc *mockCaller) CallContract(ctx context.Context, call rajchain.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockPendingCaller) PendingCallContract(ctx context.Context, call rajchain.CallMsg) ([]byte, error) {
...
func (mc *mockBlockHashCaller) CallContractAtHash(ctx context.Context, call rajchain.CallMsg, hash common.Hash) ([]byte, error) {
