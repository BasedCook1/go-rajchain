...
// This test reproduces https://github.com/rajchain/go-rajchain/issues/17837 where the
...
// not respond.
// It reproducers the issue https://github.com/rajchain/go-rajchain/issues/30156
...
// It is the reproducer for https://github.com/rajchain/go-rajchain/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-rajchain-test-ipc-%d-%d", os.Getpid(), rand.Int63())
