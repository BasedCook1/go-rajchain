...
// stateObject represents an rajchain account which is being modified.
//
...
type stateObject struct {
	db       *StateDB
	address  common.Address      // address of rajchain account
	addrHash common.Hash         // hash of rajchain address of the account
