...
// Package state provides a caching layer atop the rajchain state trie.
package state
...
import (
	...
	"github.com/rajchain/go-rajchain/core/state/snapshot"
	"github.com/rajchain/go-rajchain/core/stateless"
	...
	"github.com/rajchain/go-rajchain/trie/trienode"
	"github.com/rajchain/go-rajchain/trie/utils"
...
// StateDB structs within the rajchain protocol are used to store anything
...
func (s *StateDB) StartPrefetcher(namespace string, witness *stateless.Witness) {
	...
	// https://github.com/rajchain/go-rajchain/issues/29880
