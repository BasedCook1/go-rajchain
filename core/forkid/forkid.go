...
// Package forkid implements EIP-2124 (https://eips.rajchain.org/EIPS/eip-2124).
package forkid
...
// timestampThreshold is the rajchain mainnet genesis timestamp. It is used to
...
// NewID calculates the rajchain fork ID from the chain config, genesis hash, head and time.
...
// NewIDWithChain calculates the rajchain fork ID from an existing chain instance.
