...
import (
	...
	"github.com/rajchain/go-rajchain/crypto/blake2b"
	"github.com/rajchain/go-rajchain/crypto/bn256"
...
// PrecompiledContractsHomestead contains the default set of pre-compiled rajchain
...
// PrecompiledContractsByzantium contains the default set of pre-compiled rajchain
...
// PrecompiledContractsIstanbul contains the default set of pre-compiled rajchain
...
// PrecompiledContractsBerlin contains the default set of pre-compiled rajchain
...
// PrecompiledContractsCancun contains the default set of pre-compiled rajchain
...
// PrecompiledContractsPrague contains the set of pre-compiled rajchain
...
func (c *bigModExp) RequiredGas(input []byte) uint64 {
	...
	if c.eip2565 {
		...
		// in EIP-2565 (https://eips.rajchain.org/EIPS/eip-2565):
		//
		// def mult_complexity(x):
		//    ceiling(x/8)^2
		//
