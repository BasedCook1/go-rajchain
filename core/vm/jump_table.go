...
func newLondonInstructionSet() JumpTable {
	...
	enable3529(&instructionSet) // EIP-3529: Reduction in refunds https://eips.rajchain.org/EIPS/eip-3529
	enable3198(&instructionSet) // Base fee opcode https://eips.rajchain.org/EIPS/eip-3198
	return validate(instructionSet)
}
...
func newBerlinInstructionSet() JumpTable {
	...
	enable2929(&instructionSet) // Gas cost increases for state access opcodes https://eips.rajchain.org/EIPS/eip-2929
	return validate(instructionSet)
}
...
func newIstanbulInstructionSet() JumpTable {
	...
	enable1344(&instructionSet) // ChainID opcode - https://eips.rajchain.org/EIPS/eip-1344
	enable1884(&instructionSet) // Reprice reader opcodes - https://eips.rajchain.org/EIPS/eip-1884
	enable2200(&instructionSet) // Net metered SSTORE - https://eips.rajchain.org/EIPS/eip-2200
