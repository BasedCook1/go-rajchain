...
// Package types contains data types related to rajchain consensus.
package types
...
// Header represents a block header in the rajchain blockchain.
type Header struct {
