...
// Package utils contains internal helper functions for go-rajchain commands.
package utils
...
import (
	...
	"github.com/rajchain/go-rajchain/accounts/keystore"
	bparams "github.com/rajchain/go-rajchain/beacon/params"
	"github.com/rajchain/go-rajchain/common"
	"github.com/rajchain/go-rajchain/common/fdlimit"
	...
	"github.com/rajchain/go-rajchain/crypto/kzg4844"
	"github.com/rajchain/go-rajchain/eth"
	"github.com/rajchain/go-rajchain/eth/catalyst"
	"github.com/rajchain/go-rajchain/eth/downloader"
	"github.com/rajchain/go-rajchain/eth/ethconfig"
	"github.com/rajchain/go-rajchain/eth/filters"
	...
	"github.com/rajchain/go-rajchain/ethdb/remotedb"
	"github.com/rajchain/go-rajchain/ethstats"
	"github.com/rajchain/go-rajchain/graphql"
	...
	"github.com/rajchain/go-rajchain/metrics"
	"github.com/rajchain/go-rajchain/metrics/exp"
	"github.com/rajchain/go-rajchain/metrics/influxdb"
	...
	"github.com/rajchain/go-rajchain/p2p/nat"
	"github.com/rajchain/go-rajchain/p2p/netutil"
...
var (
	...
	StateSchemeFlag = &cli.StringFlag{
		Name:     "state.scheme",
		Usage:    "Scheme to use for storing rajchain state ('hash' or 'path')",
		Category: flags.StateCategory,
	}
...
// RegisterEthService adds an rajchain client to the stack.
// The second return value is the full node instance.
func RegisterEthService(stack *node.Node, cfg *ethconfig.Config) (*eth.EthAPIBackend, *eth.rajchain) {
	backend, err := eth.New(stack, cfg)
	if err != nil {
		Fatalf("Failed to register the rajchain service: %v", err)
	}
	stack.RegisterAPIs(tracers.APIs(backend.APIBackend))
	return backend.APIBackend, backend
}

// RegisterEthStatsService configures the rajchain Stats daemon and adds it to the node.
func RegisterEthStatsService(stack *node.Node, backend *eth.EthAPIBackend, url string) {
	if err := ethstats.New(stack, backend, backend.Engine(), url); err != nil {
		Fatalf("Failed to register the rajchain Stats service: %v", err)
	}
}
...
func RegisterFullSyncTester(stack *node.Node, eth *eth.rajchain, target common.Hash) {
