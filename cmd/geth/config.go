...
import (
	...
	"github.com/rajchain/go-rajchain/accounts/external"
	"github.com/rajchain/go-rajchain/accounts/keystore"
	"github.com/rajchain/go-rajchain/accounts/scwallet"
	"github.com/rajchain/go-rajchain/accounts/usbwallet"
...
// makeFullNode loads geth configuration and creates the rajchain backend.
func makeFullNode(ctx *cli.Context) *node.Node {
	...
	// Add the rajchain Stats daemon if requested.
	if cfg.Ethstats.URL != "" {
