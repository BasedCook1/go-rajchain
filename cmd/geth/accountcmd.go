...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Manage rajchain presale wallets",
		ArgsUsage: "",
		Description: `
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import rajchain presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
...
between rajchain nodes by simply copying.
...
Note:
As you can directly copy your encrypted accounts to another rajchain instance,
