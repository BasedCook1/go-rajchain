...
// Package ethapi implements the general rajchain API functions.
package ethapi
...
type Backend interface {
	// General rajchain API
	SyncProgress() rajchain.SyncProgress
...
func GetAPIs(apiBackend Backend) []rpc.API {
	...
	return []rpc.API{
		{
			Namespace: "eth",
			Service:   NewrajchainAPI(apiBackend),
		}, {
			Namespace: "eth",
			...
			Namespace: "eth",
			Service:   NewrajchainAccountAPI(apiBackend.AccountManager()),
		},
	}
}
