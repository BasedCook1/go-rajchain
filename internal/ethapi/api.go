...
import (
	...
	"github.com/rajchain/go-rajchain/consensus/misc/eip1559"
	...
	"github.com/rajchain/go-rajchain/crypto"
	"github.com/rajchain/go-rajchain/eth/gasestimator"
	...
	"github.com/rajchain/go-rajchain/trie"
...
// rajchainAPI provides an API to access rajchain related information.
type rajchainAPI struct {
	b Backend
}

// NewrajchainAPI creates a new rajchain protocol API.
func NewrajchainAPI(b Backend) *rajchainAPI {
	return &rajchainAPI{b}
}

// GasPrice returns a suggestion for a gas price for legacy transactions.
func (api *rajchainAPI) GasPrice(ctx context.Context) (*hexutil.Big, error) {
...
func (api *rajchainAPI) MaxPriorityFeePerGas(ctx context.Context) (*hexutil.Big, error) {
	tipcap, err := api.b.SuggestGasTipCap(ctx)
	if err != nil {
		return nil, err
	}
...
func (api *rajchainAPI) FeeHistory(ctx context.Context, blockCount math.HexOrDecimal64, lastBlock rpc.BlockNumber, rewardPercentiles []float64) (*feeHistoryResult, error) {
...
func (api *rajchainAPI) BlobBaseFee(ctx context.Context) *hexutil.Big {
...
func (api *rajchainAPI) Syncing() (interface{}, error) {
...
// rajchainAccountAPI provides an API to access accounts managed by this node.
// It offers only methods that can retrieve accounts.
type rajchainAccountAPI struct {
	am *accounts.Manager
}

// NewrajchainAccountAPI creates a new rajchainAccountAPI.
func NewrajchainAccountAPI(am *accounts.Manager) *rajchainAccountAPI {
	return &rajchainAccountAPI{am: am}
}

// Accounts returns the collection of accounts this node manages.
func (api *rajchainAccountAPI) Accounts() []common.Address {
	return api.am.Accounts()
}

// BlockChainAPI provides an API to access rajchain blockchain data.
type BlockChainAPI struct {
	b Backend
}

// NewBlockChainAPI creates a new rajchain blockchain API.
func NewBlockChainAPI(b Backend) *BlockChainAPI {
	return &BlockChainAPI{b}
}

// ChainId is the EIP-155 replay-protection chain id for the current rajchain chain config.
//
...
// keccak256("\x19rajchain Signed Message:\n" + len(message) + message).
//
...
//
// https://github.com/rajchain/wiki/wiki/JSON-RPC#eth_sign
...
// DebugAPI is the collection of rajchain APIs exposed over the debugging
// namespace.
...
// Version returns the current rajchain protocol version.
