...
import (
	...
	"github.com/rajchain/go-rajchain/version"
)

const ourPath = "github.com/rajchain/go-rajchain" // Path to our module
...
// conventions in the rajchain p2p network.
...
//
// If the package that is currently executing is a prefixed by our go-rajchain
