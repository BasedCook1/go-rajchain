...
import (
	...
	"github.com/rajchain/go-rajchain/eth/tracers/internal"
	...
	jsassets "github.com/rajchain/go-rajchain/eth/tracers/js/internal/tracers"
)

var assetTracers = make(map[string]string)

// init retrieves the JavaScript transaction tracers included in go-rajchain.
func init() {
	var err error
