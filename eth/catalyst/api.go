...
func Register(stack *node.Node, backend *eth.rajchain) error {
...
func NewConsensusAPI(eth *eth.rajchain) *ConsensusAPI {
...
func newConsensusAPIWithoutHeartbeat(eth *eth.rajchain) *ConsensusAPI {
