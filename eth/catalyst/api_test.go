...
import (
	...
	"github.com/rajchain/go-rajchain/beacon/engine"
	...
	beaconConsensus "github.com/rajchain/go-rajchain/consensus/beacon"
...
var (
	...
	// testAddr is the rajchain address of the tester account.
...
func startEthService(t *testing.T, genesis *core.Genesis, blocks []*types.Block) (*node.Node, *eth.rajchain) {
	t.Helper()
...
func setupBlocks(t *testing.T, ethservice *eth.rajchain, n int, parent *types.Header, callback func(parent *types.Header), withdrawals [][]*types.Withdrawal, beaconRoots []common.Hash) []*types.Header {
	api := NewConsensusAPI(ethservice)
...
func setupBodies(t *testing.T) (*node.Node, *eth.rajchain, []*types.Block) {
	genesis, blocks := generateMergeChain(10, true)
