...
func (api *DownloaderAPI) eventLoop() {
	var (
		...
		getProgress = func() rajchain.SyncProgress {
			prog := api.d.Progress()
...
// Syncing provides information when this node starts synchronising with the rajchain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  rajchain.SyncProgress `json:"status"`
}
