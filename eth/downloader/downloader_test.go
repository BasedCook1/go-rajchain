...
func testEmptyShortCircuit(t *testing.T, protocol uint, mode SyncMode) {
	...
	select {
	case <-success:
		checkProgress(t, tester.downloader, "initial", rajchain.SyncProgress{
...
func checkProgress(t *testing.T, d *Downloader, stage string, want rajchain.SyncProgress) {
	// Mark this method as a helper to report errors at callsite, not in here
	t.Helper()
...
func testSyncProgress(t *testing.T, protocol uint, mode SyncMode) {
	...
	defer tester.terminate()
	checkProgress(t, tester.downloader, "pristine", rajchain.SyncProgress{})
	...
	case <-success:
		// Ok, downloader fully cancelled after sync cycle
		checkProgress(t, tester.downloader, "peer-half", rajchain.SyncProgress{
	...
	case <-success:
		// Ok, downloader fully cancelled after sync cycle
		checkProgress(t, tester.downloader, "peer-full", rajchain.SyncProgress{
