...
// Package filters implements an rajchain filtering system for block,
...
func (es *EventSystem) SubscribeLogs(crit rajchain.FilterQuery, logs chan []*types.Log) (*Subscription, error) {
...
func (es *EventSystem) subscribeLogs(crit rajchain.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
