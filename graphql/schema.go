...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte rajchain address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an rajchain account at a particular block.
    type Account {
    ...
    # Transaction is an rajchain transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an rajchain account at the current block's state.
    ...
    type Pending {
        ...
        transactions: [Transaction!]
        # Account fetches an rajchain account for the pending state.
        account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an rajchain block by number or by hash. If neither is
