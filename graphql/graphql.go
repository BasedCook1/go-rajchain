...
// Package graphql provides a GraphQL interface to rajchain node data.
package graphql
...
// Account represents an rajchain account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an rajchain transaction.
...
// Block represents an rajchain block.
...
type CallData struct {
	From                 *common.Address // The rajchain address the call is from.
	To                   *common.Address // The rajchain address the call is to.
...
type SyncState struct {
	progress rajchain.SyncProgress
}
